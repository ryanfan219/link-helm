const translations = {
  en: {
    ...
    downloadEyebrow: "Source build", downloadTitle: "Package Link Helm for all three platforms", downloadDetail: "Install Rust stable, Tauri CLI 2, and each platform's native build prerequisites. Build on the target operating system; Linux packages require Linux system libraries.", macPackageDetail: "Build an unsigned app or DMG on macOS with Xcode Command Line Tools installed.", windowsPackageDetail: "Build the NSIS installer on Windows 10/11 x64 with Visual Studio Build Tools installed.", linuxPackageDetail: "Build the Debian package and AppImage on Linux after installing WebKitGTK, AppIndicator, and XDG dependencies.", outputLabel: "Output", fullInstructions: "Full instructions",
  ...
  zh: {
    ...
    downloadEyebrow: "源码构建", downloadTitle: "为三个平台打包 Link Helm", downloadDetail: "先安装 Rust stable、Tauri CLI 2 和各平台原生构建依赖，再在目标操作系统上执行打包；Linux 包依赖 Linux 系统库。", macPackageDetail: "在已安装 Xcode Command Line Tools 的 macOS 上构建未签名 App 或 DMG。", windowsPackageDetail: "在已安装 Visual Studio Build Tools 的 Windows 10/11 x64 上构建 NSIS 安装程序。", linuxPackageDetail: "安装 WebKitGTK、AppIndicator 和 XDG 依赖后，在 Linux 上构建 Debian 安装包与 AppImage。", outputLabel: "产物", fullInstructions: "查看完整说明",
