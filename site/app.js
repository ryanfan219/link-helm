const translations = {
  en: {
    skip: "Skip to content", navLabel: "Primary navigation", navWorkflow: "How it works", navCompatibility: "Compatibility", navDownload: "Build Lynko",
    ...
    productEyebrow: "Control without context switching", productTitle: "A quiet control surface for every incoming link", productDetail: "Set Lynko as the default browser, define precise rules, preview routing decisions, and keep sensitive URL paths out of diagnostics.", productAlt: "Lynko settings showing default browser, accessibility, routing controls, and browser profile testing", productCaption: "The current Lynko settings interface on macOS.",
    workflowEyebrow: "Routing pipeline", workflowTitle: "Context in. Correct identity out.", workflowDetail: "Lynko evaluates only the context needed to make a routing decision.",
  ...
  zh: {
    ...
    productEyebrow: "无需切换上下文的控制", productTitle: "安静管理每一个传入链接", productDetail: "将 Lynko 设为默认浏览器，定义精确规则、预览路由结果，并避免在诊断记录中保存敏感 URL 路径。", productAlt: "Lynko 设置界面，展示默认浏览器、辅助功能、路由控制和浏览器身份测试", productCaption: "当前 macOS 版 Lynko 设置界面。",
    workflowEyebrow: "路由流程", workflowTitle: "输入上下文，输出正确身份。", workflowDetail: "Lynko 只评估作出路由决策所需的上下文。",
    ...
    compatibilityEyebrow: "当前支持", compatibilityTitle: "已验证的明确标注，未验证的如实说明", compatibilityDetail: "Lynko 仍处于早期阶段。下表区分已验证行为、适配器级支持和后续计划。", tablePlatform: "平台", tableBrowser: "浏览器", tableStatus: "状态", statusValidated: "已验证", statusPartial: "适配器级支持，尚未充分验证", allBrowsers: "所有浏览器", statusPlanned: "计划支持",
    downloadEyebrow: "源码构建", downloadTitle: "在 Mac 上构建 Lynko", downloadDetail: "直接从源码生成应用包或对应架构的 DMG。", sourceInstructions: "源码构建说明",
...
function applyLanguage(language) {
  ...
  window.localStorage.setItem("lynko-site-language", language);
}

languageButton.addEventListener("click", () => applyLanguage(languageButton.dataset.nextLanguage));

const savedLanguage = window.localStorage.getItem("lynko-site-language");
